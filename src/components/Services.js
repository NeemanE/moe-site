        ...
        <div id='services'>
            ...
            <div>
                <CardGroup className='service-cardgroup1'>
                    <Card className='service-card' onClick={handleModal1Show} style={{ marginRight: '2vw' }}>
                    ...
                    <Card className='service-card' onClick={handleModal2Show} style={{ marginRight: '2vw' }}>
            ...
            <div>
                <CardGroup className='service-cardgroup2'>
                    <Card className='service-card' onClick={handleModal4Show} style={{ marginRight: '2vw' }}>
                    ...
                    <Card className='service-card' onClick={handleModal5Show} style={{ marginRight: '2vw' }}>
            ...
            <div>
                <CardGroup className='service-cardgroup3'>
                    <Card className='service-card' onClick={handleModal7Show} style={{ marginRight: '2vw' }}>
                        <Card.Img variant="top" src={marketing} style={{ height: '100%', objectFit: 'cover' }} />
                        <div style={{ backgroundColor: '#0f3d62', width: '100%', position: 'absolute', bottom: '0' }}>
                            <Card.Title style={{ textAlign: 'center', color: 'white', padding: '0.5rem' }}>Business Promotional Products</Card.Title>
                        </div>
                    </Card>
                    <Card className='service-card' onClick={handleModal8Show} style={{ marginRight: '2vw' }}>
                        <Card.Img variant="top" src={webDesign} style={{ height: '100%', objectFit: 'cover' }} />
                        <div style={{ backgroundColor: '#0f3d62', width: '100%', position: 'absolute', bottom: '0' }}>
                            <Card.Title style={{ textAlign: 'center', color: 'white', padding: '0.5rem' }}>Web Design/Domain Hosting</Card.Title>
                        </div>                </Card>
                    <Card className='service-card' onClick={handleModal9Show}>
                        <Card.Img variant="top" src={autoInsurance} style={{ height: '100%', objectFit: 'cover' }} />
                        <div style={{ backgroundColor: '#0f3d62', width: '100%', position: 'absolute', bottom: '0' }}>
                            <Card.Title style={{ textAlign: 'center', color: 'white', padding: '0.5rem' }}>Auto Insurance (Coming Soon)</Card.Title>
                        </div>                </Card>
                </CardGroup>
            </div>
            <Modal show={showModal1} onHide={handleModal1Close} centered>
                ...
                <Modal.Body>
                    <p>Your business credit can be as important as your personal credit. Creditors and suppliers are increasingly using business credit reports to make lending and credit decisions. Establishing business credit may seem like a daunting process—especially if your business is new. BUT, at Protocall Financial, We Will be with you every step of the way to help you achieve your business Credit Goals.</p>
                </Modal.Body>
            </Modal>
            ...
            <Modal show={showModal3} onHide={handleModal3Close} centered>
                ...
                <Modal.Body>
                    ...
                    <p>
                        <span style={{ fontWeight: 'bold' }}>Top Reasons for Business Formation :</span>
            ...
            <Modal show={showModal4} onHide={handleModal4Close} centered>
                <Modal.Header closeButton>
                    <Modal.Title>Merchant Services
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <p>There are many services out there for you to choose from. Every company has their own pricing and options, but when it comes time to make a decision, you want to get the best option for your business. We want you to choose us TODAY, so give us a call today and allow Protocall Financial to put more money in your pocket by offering you the best Merchant Service rates in the market!</p>
                </Modal.Body>
            </Modal>
            <Modal show={showModal5} onHide={handleModal5Close} centered>
                ...
                <Modal.Body>
                    <p>Need a document notarized but don't want the hassle of finding one? Just give us a call! We offer notary services directly to you, any part of town, any time of day.</p>
                </Modal.Body>
            </Modal>
            <Modal show={showModal6} onHide={handleModal6Close} centered>
                ...
                <Modal.Body>
                    <p>Specializing in Individual and Small Business/LLC returns, we make tax season easy for you, and your wallet! Just bring us your documents and let us handle the rest. </p>
                </Modal.Body>
            </Modal>
            ...
            <Modal show={showModal8} onHide={handleModal8Close} centered>
                ...
                <Modal.Body>
                    <p>Need a website? Everyone does to succeed in their business! Let us build you your perfect website suited for your business and your needs, with no headaches. All of our websites come with domains, so your site is ready to launch whenever you are.</p>
                </Modal.Body>
            </Modal>
            <Modal /* show={showModal9} onHide={handleModal9Close} */ centered> {/* Commented out until the service is ready for launch with description */}
                <Modal.Header closeButton>
