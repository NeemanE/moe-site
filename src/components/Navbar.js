        ...
        <section className="navbar">
            ...
            <div className="navLogin">
                <div className="buttonContainer">
                    <Button variant="primary rounded-0" size="" href="https://www.creditrestorationportal.com/account/login?fbclid=IwAR3ORa-__TREhUVGqQFhWWl1BEcsxwS9xQ-8d82rmz3oyotNe7baU17LB64">Client Login</Button>
                    <Button variant="primary rounded-0" href="https://www.affiliatecreditrepairportal.com/account/login?fbclid=IwAR3ORa-__TREhUVGqQFhWWl1BEcsxwS9xQ-8d82rmz3oyotNe7baU17LB64">Affiliate Login</Button>
                </div>
            </div>
        </section>
    );
